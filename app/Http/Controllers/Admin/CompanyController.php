...
class CompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        $companies = Company::with(['product_categories', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.companies.create', compact('product_categories'));
    }

    public function store(StoreCompanyRequest $request)
    {
        $company = Company::create($request->all());
        $company->product_categories()->sync($request->input('product_categories', []));
    ...
    public function edit(Company $company)
    {
        ...
        $company->load('product_categories');

        return view('admin.companies.edit', compact('company', 'product_categories'));
    }
