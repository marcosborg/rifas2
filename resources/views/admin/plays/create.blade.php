...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.play.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.plays.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="number" name="type" id="type" value="{{ old('type', '1') }}" step="1" required>
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('play') ? 'is-invalid' : '' }}" type="number" name="play" id="play" value="{{ old('play', '') }}" step="1" required>
                @if($errors->has('play'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('selection') ? 'is-invalid' : '' }}" type="number" name="selection" id="selection" value="{{ old('selection', '') }}" step="1" required>
