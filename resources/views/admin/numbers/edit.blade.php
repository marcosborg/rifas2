    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.numbers.update", [$number->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $number->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $number->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $number->end_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('donation') ? 'is-invalid' : '' }}" type="number" name="donation" id="donation" value="{{ old('donation', $number->donation) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('start_number') ? 'is-invalid' : '' }}" type="number" name="start_number" id="start_number" value="{{ old('start_number', $number->start_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_number') ? 'is-invalid' : '' }}" type="number" name="end_number" id="end_number" value="{{ old('end_number', $number->end_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('award') ? 'is-invalid' : '' }}" name="award_id" id="award_id" required>
                    @foreach($awards as $id => $entry)
                        <option value="{{ $id }}" {{ (old('award_id') ? old('award_id') : $number->award->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('award'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('benefactor') ? 'is-invalid' : '' }}" name="benefactor_id" id="benefactor_id" required>
                    @foreach($benefactors as $id => $entry)
                        <option value="{{ $id }}" {{ (old('benefactor_id') ? old('benefactor_id') : $number->benefactor->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
