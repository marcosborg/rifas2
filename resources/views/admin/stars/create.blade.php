    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.stars.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('star_1') ? 'is-invalid' : '' }}" type="number" name="star_1" id="star_1" value="{{ old('star_1', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('star_2') ? 'is-invalid' : '' }}" type="number" name="star_2" id="star_2" value="{{ old('star_2', '') }}" step="1">
